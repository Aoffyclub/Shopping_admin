      ...
      <div className="pl-12 gap-4 flex flex-col mt-6">
        ...
        <div className="w-[80%] flex gap-2 items-center">
          <label htmlFor="file-input">
            <img
              src={image ? URL.createObjectURL(image) : icons}
              alt=""
              className="h-[200px] rounded-sm inline-block"
            />
          </label>
          <input
        ...
        <button
          onClick={() => addProduct()}
          className="bg-black rounded-xl text-center text-white text-xl py-2 w-[200px]"
        >
          Add Product
        </button>
